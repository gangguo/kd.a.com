<?php
/* Smarty version 3.1.32-dev-45, created on 2019-02-26 12:02:28
  from '/Users/gangkui/wwwroot/www/video.a.com/web/admin/template/member.add.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32-dev-45',
  'unifunc' => 'content_5c74ba54e94062_20047088',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '15f2964ce332ab721bc2db5d5ea398c05b48573c' => 
    array (
      0 => '/Users/gangkui/wwwroot/www/video.a.com/web/admin/template/member.add.tpl',
      1 => 1551153745,
      2 => 'file',
    ),
  ),
...
function content_5c74ba54e94062_20047088 (Smarty_Internal_Template $_smarty_tpl) {
        ...
        <div class="row">
            ...
            <div class="widget-box">
                <form class="form-horizontal" action="?ct=member&ac=save" id="validateForm" novalidate="novalidate" action="" method="POST">
                    ...
                    <input type="hidden" name="member_id" value="<?php if (empty($_smarty_tpl->tpl_vars['data']->value['member_id'])) {?>0<?php } else {
echo $_smarty_tpl->tpl_vars['data']->value['member_id'];
}?>" />
                    ...
                    <div class="widget-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="<?php if (empty($_smarty_tpl->tpl_vars['data']->value['username'])) {
} else {
echo $_smarty_tpl->tpl_vars['data']->value['username'];
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="<?php if (empty($_smarty_tpl->tpl_vars['data']->value['password'])) {
} else {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name='nickname' class="form-control" datatype="*" nullmsg="请输入真实姓名"
                                       value="<?php if (empty($_smarty_tpl->tpl_vars['data']->value['nickname'])) {
} else {
echo $_smarty_tpl->tpl_vars['data']->value['nickname'];
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="status" class="form-control" datatype="*" nullmsg="请输入分类">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['data']->value['status'])) {?>
                                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['status']->value,'selected'=>$_smarty_tpl->tpl_vars['data']->value['status']),$_smarty_tpl);?>
                            ...
                            <div class="col-sm-4">
                                <select name="sex" class="form-control" datatype="*" nullmsg="请输入分类">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['data']->value['sex'])) {?>
                                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['sexs']->value,'selected'=>$_smarty_tpl->tpl_vars['data']->value['sex']),$_smarty_tpl);?>

                                    <?php } else { ?>
                                    <?php echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['sexs']->value),$_smarty_tpl);?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                value="<?php if (empty($_smarty_tpl->tpl_vars['data']->value['email'])) {
} else {
