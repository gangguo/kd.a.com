<?php
/* Smarty version 3.1.32-dev-45, created on 2019-02-25 12:42:39
  from '/Users/gangkui/wwwroot/www/video.a.com/web/admin/template/index2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32-dev-45',
  'unifunc' => 'content_5c73723f8706b3_38008321',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0861f5e126639323821e6d28cb335c467394a5fa' => 
    array (
      0 => '/Users/gangkui/wwwroot/www/video.a.com/web/admin/template/index2.tpl',
      1 => 1551005473,
      2 => 'file',
    ),
  ),
...
function content_5c73723f8706b3_38008321 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
>
    <?php echo '<script'; ?>
 src="static/frame/js/common.js"><?php echo '</script'; ?>
>
</head>
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="true">
                            ...
                            <div class="pull-left user-info-r">
                                <div class="user-info-r-inner">
                                    ...
                                    <p><?php echo $_smarty_tpl->tpl_vars['user']->value['realname'];?>
</p>
                                </div>
...
>
    <?php echo '<script'; ?>
 src="static/frame/js/plugins/metisMenu/jquery.metisMenu.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/plugins/slimscroll/jquery.slimscroll.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/plugins/layer/layer.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/plugins/pace/pace.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/plugins/toastr/toastr.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/plugins/switch/switch.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/ui2/js/hplus.min.js?v=4.1.0"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/ui2/js/contabs.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/jquery.gritter.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/jquery.peity.min.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/interface.js"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/crypto-js.js<?php echo $_smarty_tpl->tpl_vars['clear_cache']->value;?>
"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
...
"><?php echo '</script'; ?>
>
    <?php if (!empty($_smarty_tpl->tpl_vars['websocket_url']->value) && !empty($_smarty_tpl->tpl_vars['websocket_key']->value)) {?>
    <?php echo '<script'; ?>
>
    var WEBSOCKET_URL = '<?php echo $_smarty_tpl->tpl_vars['websocket_url']->value;?>
';
    var WEBSOCKET_KEY = '<?php echo $_smarty_tpl->tpl_vars['websocket_key']->value;?>
';
    <?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="static/frame/js/websocket.js<?php echo $_smarty_tpl->tpl_vars['clear_cache']->value;?>
"><?php echo '</script'; ?>
>
    <?php }?>
    <?php echo '<script'; ?>
>
        var MenuData = <?php echo $_smarty_tpl->tpl_vars['menus']->value;?>
;
