...
use kali\core\cache;
//use kali\core\router;
//use kali\core\socket;
//use kali\core\log;
use kali\core\event;
use kali\core\lib\cls_benchmark;
...
class kali
{
    ...
    private static function init()
    {
        ...
        set_error_handler(['kali\core\errorhandler', 'error_handler'], E_ALL);
        set_exception_handler(['kali\core\errorhandler', 'exception_handler']);
