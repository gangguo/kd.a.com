...
class ctl_oauth_scopes
{
    ...
    public function add()
    {
        if (!empty(req::$posts))
        {
            ...
            cls_auth::save_admin_log("授权添加 {$insert_id}");
    ...
    public function edit()
    {
        ...
        if (!empty(req::$posts))
        {
            ...
            cls_auth::save_admin_log("授权修改 {$id}");
    ...
    public function edit_batch()
    {
        ...
        cls_auth::save_admin_log("授权批量修改 ".implode(",", $ids));
    ...
    public function del()
    {
        ...
        cls_auth::save_admin_log("授权删除 ".implode(",", $ids));
