            ...
            <div class="widget-box">
                ...
                <div class="widget-content p-b-none">
                    <div class="btn-outline-wrap">
                        <a href="?ct=message&ac=index" class="btn btn-success"><i class="fa fa-bars"></i>内容列表</a>
                        <a href="?ct=message&ac=add" class="btn btn-info btn-outline"><i class="fa fa-plus-circle"></i>内容添加</a>
