                    ...
                    <div class="widget-filemanage widget-content">
                        <div class="form-group uploader-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <a class="btn btn-dark uploader-picker" data-file="image1"><i class="fa fa-upload"></i> 选择文件</a>
                        ...
                        <div class="form-group uploader-group" data-multiple="false" data-auto="true" data-len="" data-size="2" data-maxlen="3">
                            <label class="col-sm-2 control-label"><code>*</code> 文件2:</label>
                            <div class="col-sm-10">
                                <div class="uploader-list"></div>
                                <a class="btn btn-dark uploader-picker" data-file="image2"><i class="fa fa-upload"></i> 选择文件</a>
