                    ...
                    <table class="table table-bordered table-hover table-agl-c with-check">
                        ...
                        <{foreach from=$list item=v}>
                            <tr>
                                ...
                                <td>
                                    <!--a href="?ct=cate&ac=info&id=<{$v.cate_id}>" class="btn btn-success btn-xs"><i class="fa fa-search"></i>查看</a-->
                                    <a href="?ct=cate&ac=edit&id=<{$v.cate_id}>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i>修改</a>
                                </td>
                            </tr>
                            <{foreachelse}>
                            <tr>
